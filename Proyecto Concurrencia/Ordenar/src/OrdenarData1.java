 ...
 */
public class OrdenarData1 {
    	
	static ArrayList<Estructura> wordcount=new ArrayList();

    public static void OrdenarData1(String file) throws FileNotFoundException, IOException {
	File archivo = new File (file);
	Scanner sc=new Scanner(archivo);
	Scanner s=null;
	FileWriter fichero = new FileWriter("./src/WordCount1_Ordenado1.txt");
